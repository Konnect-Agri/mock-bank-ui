  ...
  return (
    <>
      <div className="container-fluid">
        ...
        <div className="bg-white container-fluid" style={{ borderRadius: "10px" }}>
          <Container>
            <>
            <>
        <Container>
          <Row >
            <Col></Col>
            <Col className="mt-5"><Table bordered>
            <tbody>
              <tr>
            ...
            <Col></Col>
              ...
              <div className="font-regular bg-white bg-opacity-70 rounded mb-16 px-11 py-16">
                <Row className="px-2" style={{overflowX:'scroll'}}>
